...
In this lab you'll be using methods to iterate through an array and output the results in different ways.
...
This time we'll be working in the below method in `FISAppDelegate`.
